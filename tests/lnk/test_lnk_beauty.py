...
def test_lnk_beauty_max_width_60_if_no_terminal():
	assert lnk.beauty.MAX_WIDTH == 60

	# What we'll use for testing
	lnk.beauty.MAX_WIDTH = 10

def test_lnk_beauty_escape_escapes_well(fixture):
...
def test_lnk_beauty_escape_leaves_strings_w_o_escape_codes_alone(fixture):
...
def test_lnk_beauty_wrap_works_well(fixture):
	line = lnk.beauty.escape(fixture[0][0])
...
def test_lnk_beauty_boxify_works_well(fixture):
